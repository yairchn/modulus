...
if __name__ == '__main__':
    ...
    plot_baseline_metrics(
        forecast_params=[
            {
                'file':'path/to/forecast_file.nc',
                'verification_file':'path/to/dataset/dataset_name.zarr',
                'climatology_file':'path/to/climatology_cache.nc',
                'rmse_cache':'path/to/cache/rmse_cache.nc',
                'acc_cache':'path/to/cache/acc_cache.nc',
                'plot_kwargs':{'label':'model_name','color':'blue','linewidth':2, 'linestyle':'--'},  
            }
        ],
        variable='z500',
        plot_file='path/to/output_plot.png',
    )
